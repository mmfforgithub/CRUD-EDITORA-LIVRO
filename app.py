...
conexao = 'mysql+pymysql://alunos:cefetmg@127.0.0.1/bibliófilo'
...
from modulos.livro.livro import bp_livro
from modulos.pedidos.pedidos import bp_pedidos
app.register_blueprint(bp_usuario, url_prefix='/editora')
app.register_blueprint(bp_pizza, url_prefix='/livro')
